...
var projects = new []
{
    sourceDir.Path + "TestAPI/TestAPI.csproj",
...
```yaml
...
    Unicorn ImagesFunction:
        Type: AWS::Serverless::Function
        Properties:
            CodeUri: ./artifacts/Unicorn Images.zip
            ...
```
...
```bash
dotnet test Unicorn Images.Test
```
...
aws cloudformation describe-stacks \
    --stack-name unicorn-images --query 'Stacks[].Outputs'
```
